            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  ...
                  title={searchMode === "spreading" ? "Spreading Activation (AI)" : "Vector Search (Vec)"}
                  aria-label={searchMode === "spreading" ? "Search mode: Spreading Activation" : "Search mode: Vector Search"}
                >
