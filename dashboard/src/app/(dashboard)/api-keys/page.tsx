              ...
              <div className="space-y-4 py-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2">
                    ...
                    />
                    <Button variant="outline" size="icon" aria-label="Toggle key visibility" onClick={() => setShowKey(!showKey)}>
                      {showKey ? <EyeOff className="h-4 w-4" /> : <Eye className="h-4 w-4" />}
                    </Button>
                    <Button variant="outline" size="icon" aria-label="Copy API key" onClick={() => copyToClipboard(createdKey)}>
