        ...
        <div className="container mx-auto flex items-center justify-between gap-4">
          ...
          <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-primary">
            <svg viewBox="0 0 128 128" className="h-5 w-5" fill="none" xmlns="http://www.w3.org/2000/svg">
              <defs>
                <linearGradient id="logoGradDemo" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#6366f1"/>
                  <stop offset="100%" stopColor="#8b5cf6"/>
                </linearGradient>
              </defs>
              <circle cx="64" cy="64" r="12" fill="url(#logoGradDemo)"/>
              <circle cx="32" cy="40" r="7" fill="url(#logoGradDemo)" opacity="0.9"/>
              <circle cx="96" cy="40" r="7" fill="url(#logoGradDemo)" opacity="0.9"/>
              <circle cx="32" cy="88" r="7" fill="url(#logoGradDemo)" opacity="0.9"/>
              <circle cx="96" cy="88" r="7" fill="url(#logoGradDemo)" opacity="0.9"/>
              <circle cx="64" cy="24" r="5" fill="url(#logoGradDemo)" opacity="0.7"/>
              <circle cx="64" cy="104" r="5" fill="url(#logoGradDemo)" opacity="0.7"/>
