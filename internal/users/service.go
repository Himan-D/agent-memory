...
func (s *Service) CreateInvite(req *CreateInviteRequest, invitedBy uuid.UUID) (*Invite, error) {
	...
	if s.notifSvc != nil {
		inviteLink := fmt.Sprintf("https://app.hystersis.com/auth/signup?invite=%s", invite.ID.String())
...
func (s *Service) AcceptInvite(id uuid.UUID) error {
	...
	if s.notifSvc != nil {
		...
		<body>
			...
			<p>You can now <a href="https://app.hystersis.com/auth/signin">sign in</a> to your account.</p>
