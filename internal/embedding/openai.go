...
type OpenAIEmbedding struct {
	...
	BaseURL   string // for testing or alternative endpoints
}
...
func (e *OpenAIEmbedding) GenerateBatchEmbeddingsWithContext(ctx context.Context, texts []string) ([][]float32, error) {
	...
	// Optimization: Pre-allocate result slice and track fetch indices to handle
	// mixed cache hits/misses while maintaining original input order.
