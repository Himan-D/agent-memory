...
description: Deploy Hystersis with Docker Compose for development and production, including Neo4j, Qdrant, Redis, and OpenAI chat and embedding model environment variables.
---
...
# OpenAI chat + embedding models (split in recent releases)
OPENAI_MODEL=gpt-4o
