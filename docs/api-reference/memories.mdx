...
**Example:**
```bash
curl -X GET "https://api.hystersis.ai/memories?user_id=user-123&category=preferences&limit=10" \
  -H "X-API-Key: your-api-key"
```
...
**Example:**
```bash
curl -X GET https://api.hystersis.ai/memories/mem_abc123def456 \
  -H "X-API-Key: your-api-key"
```
...
**Example:**
```bash
curl -X PUT https://api.hystersis.ai/memories/mem_abc123def456 \
  -H "X-API-Key: your-api-key" \
  -H "Content-Type: application/json" \
  -d '{
    "content": "User prefers dark mode and works late hours, also likes coffee"
...
**Example:**
```bash
curl -X DELETE https://api.hystersis.ai/memories/mem_abc123def456 \
  -H "X-API-Key: your-api-key"
```
