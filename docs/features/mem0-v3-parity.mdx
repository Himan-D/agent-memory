...
| Benchmarks | Published LoCoMo, LongMemEval, BEAM results | Local benchmark packages exist, no public reproduced report | Behind |
...
| Multi-tenancy | Mature scoping semantics | Tenant fields and RBAC exist; leakage tests need expansion | Needs proof |
...
| --- | --- | --- |
| P0 | Public benchmark runner | Reproducible LoCoMo, LongMemEval, and BEAM-style reports committed under `benchmarks/` or `docs/benchmarks/` |
...
| P1 | Tenant isolation | Search, get, batch, graph, and source endpoints have cross-tenant negative tests |
