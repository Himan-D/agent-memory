...
curl -H "X-API-Key: your-api-key" \
  -X GET "https://api.hystersis.ai/api-keys"
```
...
curl -H "X-API-Key: your-api-key" \
  ...
  -X GET "https://api.hystersis.ai/auth/me"
```
...
curl -H "X-API-Key: your-api-key" \
  -X GET "https://api.hystersis.ai/memories"
...
curl -H "X-API-Key: your-api-key" \
  -X POST "https://api.hystersis.ai/sessions/session_123/context" \
  -H "Content-Type: application/json" \
  -d '{"context_updates": {"conversation_history": []}}'

# Increase context window
curl -H "X-API-Key: your-api-key" \
  -X PUT "https://api.hystersis.ai/sessions/session_123" \
  -H "Content-Type: application/json" \
...
curl -H "X-API-Key: your-api-key" \
  -X GET "https://api.hystersis.ai/search?q=preference&limit=50"

# Check search statistics
curl -H "X-API-Key: your-api-key" \
  -X GET "https://api.hystersis.ai/search/stats"

# Adjust search threshold
curl -H "X-API-Key: your-api-key" \
  -X GET "https://api.hystersis.ai/search?q=preference&threshold=0.5"
```
...
curl -H "X-API-Key: your-api-key" \
  -X GET "https://api.hystersis.ai/compression/stats"

# Test compression with simpler content
curl -H "X-API-Key: your-api-key" \
  -X POST "https://api.hystersis.ai/compression/process" \
  -H "Content-Type: application/json" \
  -d '{"content": "Simple test content", "options": {"compression_enabled": true}}'

# Check compression configuration
curl -H "X-API-Key: your-api-key" \
  -X GET "https://api.hystersis.ai/compression/config"
```
...
curl -H "X-API-Key: your-api-key" \
  -X GET "https://api.hystersis.ai/webhooks/delivery-logs"

# Test webhook endpoint
curl -H "X-API-Key: your-api-key" \
  -X POST "https://api.hystersis.ai/webhooks/webhook_id/test" \
  -H "Content-Type: application/json" \
  -d '{"event": "memory.created", "test_payload": {"memory": {"id": "test", "content": "test"}}}'

# Check webhook configuration
curl -H "X-API-Key: your-api-key" \
  -X GET "https://api.hystersis.ai/webhooks/webhook_id"
```
...
curl -H "X-API-Key: your-api-key" \
  -X GET "https://api.hystersis.ai/admin/metrics"
...
curl -H "X-API-Key: your-api-key" \
  -X GET "https://api.hystersis.ai/admin/health"

# Increase worker pool
curl -H "X-API-Key: your-api-key" \
  -X PUT "https://api.hystersis.ai/compression/config" \
  -H "Content-Type: application/json" \
...
curl -H "X-API-Key: your-api-key" \
  -X GET "https://api.hystersis.ai/memories/stats"

# Enable memory compression
curl -H "X-API-Key: your-api-key" \
  -X PUT "https://api.hystersis.ai/tier/policy" \
  -H "Content-Type: application/json" \
  -d '{"policy": "aggressive"}'
```
...
curl -H "X-API-Key: your-api-key" \
  -X DELETE "https://api.hystersis.ai/memories/bulk-delete" \
  -H "Content-Type: application/json" \
  -d '{"filters": {"created_before": "2024-01-01T00:00:00Z"}, "confirm": true}'

# Run system cleanup
curl -H "X-API-Key: your-api-key" \
  -X POST "https://api.hystersis.ai/admin/cleanup" \
  -H "Content-Type: application/json" \
...
```bash
# Test API endpoint
curl -X GET "https://api.hystersis.ai/health"

# Test API with verbose output
curl -v -X GET "https://api.hystersis.ai/health"
```

**2. Check Network Configuration**
```bash
# Check DNS resolution
nslookup api.hystersis.ai

# Check network connectivity
telnet api.hystersis.ai 443
```
...
curl -X GET "https://api.hystersis.ai/metrics"
...
curl -H "X-API-Key: your-api-key" \
  -X GET "https://api.hystersis.ai/admin/logs"
...
API_URL="https://api.hystersis.ai"
API_KEY="your-api-key"
...
- Discord Community: https://discord.gg/hystersis
- Stack Overflow: https://stackoverflow.com/questions/tagged/hystersis

**3. Professional Support**
- Email: support@hystersis.ai
- Support portal: https://support.hystersis.ai
- Enterprise support: sales@hystersis.ai
...
curl -v -X POST "https://api.hystersis.ai/memories" \
...
curl -X POST "https://api.hystersis.ai/admin/profiling/cpu" \
  -H "X-API-Key: your-api-key"

# Download profile
curl -X GET "https://api.hystersis.ai/admin/profiling/cpu/download" \
  -o cpu_profile.pprof
```
...
curl -X POST "https://api.hystersis.ai/admin/profiling/memory" \
  -H "X-API-Key: your-api-key"

# Download profile
curl -X GET "https://api.hystersis.ai/admin/profiling/memory/download" \
...
| Issue | Command |
|-------|---------|
| Check API health | `curl -X GET "https://api.hystersis.ai/health"` |
| List memories | `curl -H "X-API-Key: key" -X GET "https://api.hystersis.ai/memories"` |
| Check compression stats | `curl -H "X-API-Key: key" -X GET "https://api.hystersis.ai/compression/stats"` |
| Check webhook logs | `curl -H "X-API-Key: key" -X GET "https://api.hystersis.ai/webhooks/delivery-logs"` |
| Run system cleanup | `curl -H "X-API-Key: key" -X POST "https://api.hystersis.ai/admin/cleanup"` |
