...
3. **Async Pipeline** — Non-blocking compression with <5ms write latency impact
...
|------|---------|---------|-----------|
| Working | In-memory | <5ms | Current session |
| Hot | Redis | <20ms | 7 days (balanced) |
| Cold | Neo4j + Qdrant | <100ms | 90 days |
