...
export default function SettingsPage() {
  ...
  // Adapt mock user to Next.js shape temporarily for minimal changes
  const session = sessionUser ? {
    user: {
      name: sessionUser.name,
      email: sessionUser.email,
      image: sessionUser.avatar_url,
  ...
  const [apiConfig, setApiConfig] = useState({
    baseUrl: import.meta.env.VITE_API_URL || "https://api.hystersis.com",
    timeout: 30,
    retries: 3,
  });
