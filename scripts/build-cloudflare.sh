...
echo ""
    Dashboard (agent-memorydash → app.hystersis.com) deploys separately.
    Do NOT deploy dashboard from this build — both used name agent-memorydash and overwrote landing.
