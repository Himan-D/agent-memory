      ...
      >
        <div className="navbar-content">
          ...
          <div className="navbar-actions">
            ...
            <a href="https://calendly.com/hystersis/30min" className="nav-cta" target="_blank" rel="noopener noreferrer">
              Book Demo
            </a>
          </div>
        ...
        {mobileMenuOpen && (
          ...
          >
            ...
            <div className="mobile-actions">
              ...
              <a href="https://calendly.com/hystersis/30min" className="mobile-cta" target="_blank" rel="noopener noreferrer">
                Book Demo
              </a>
            </div>
          </motion.div>
