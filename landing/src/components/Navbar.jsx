      ...
      >
        <div className="navbar-content">
          ...
          <div className="navbar-actions">
            ...
            <a href="#" className="nav-cta" onClick={(e) => { e.preventDefault(); if (window.Calendly) { window.Calendly.initPopupWidget({ url: 'https://calendly.com/himanshu-dixit-trinetralabs/30min' }); } else { window.open('https://calendly.com/himanshu-dixit-trinetralabs/30min', '_blank'); } return false; }}>
              Book Demo
            </a>
          </div>
        ...
        {mobileMenuOpen && (
          ...
          >
            ...
            <div className="mobile-actions">
              ...
              <a href="#" className="mobile-cta" onClick={(e) => { e.preventDefault(); setMobileMenuOpen(false); if (window.Calendly) { window.Calendly.initPopupWidget({ url: 'https://calendly.com/himanshu-dixit-trinetralabs/30min' }); } else { window.open('https://calendly.com/himanshu-dixit-trinetralabs/30min', '_blank'); } return false; }}>
                Book Demo
              </a>
            </div>
          </motion.div>
