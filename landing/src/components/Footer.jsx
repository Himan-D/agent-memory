      ...
      <div className="container">
        ...
        >
          ...
          <div className="footer-links">
            ...
            <div className="footer-col">
              <h4>Connect</h4>
              <a href="https://twitter.com/himanshu_d" target="_blank" rel="noopener noreferrer">Twitter</a>
        ...
        <div className="footer-bottom">
          ...
          <div className="footer-social">
            ...
            <a href="https://twitter.com/himanshu_d" aria-label="Twitter" target="_blank" rel="noopener noreferrer">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
