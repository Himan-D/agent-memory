...
export declare const EXCLUDE_INTERNAL_REFERRERS_CONDITIONS: {
    ...
    readonly ifEmptyCampaign: "ifEmptyCampaign";
};
type ExcludeInternalReferrersCondition = (typeof EXCLUDE_INTERNAL_REFERRERS_CONDITIONS)[keyof typeof EXCLUDE_INTERNAL_REFERRERS_CONDITIONS];
