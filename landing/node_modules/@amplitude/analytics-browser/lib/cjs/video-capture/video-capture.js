    ...
    VideoCapture.prototype.captureVideoStarted = function () {
        ...
        this.listeners.push(function (previousState, nextState) {
            if (previousState.playbackState !== 'playing' && nextState.playbackState === 'playing') {
                ...
                _this.amplitude.track('Video Content Started', tslib_1.__assign(tslib_1.__assign({}, _this.extraEventProperties), nextState.lastEvent));
            }
        });
        return this;
    };
    ...
    VideoCapture.prototype.captureVideoStopped = function () {
        ...
        this.listeners.push(function (previousState, nextState) {
            if (previousState.playbackState === 'playing' && nextState.playbackState !== 'playing') {
                ...
                _this.amplitude.track('Video Content Stopped', tslib_1.__assign(tslib_1.__assign({}, _this.extraEventProperties), nextState.lastEvent));
            }
        });
        return this;
    };
