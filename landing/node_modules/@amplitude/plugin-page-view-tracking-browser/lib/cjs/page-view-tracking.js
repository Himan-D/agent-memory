...
var getCampaignParams = function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () { var _a; return tslib_1.__generator(this, function (_b) {
    switch (_b.label) {
        case 0:
            ...
            return [4 /*yield*/, new analytics_core_1.CampaignParser().parse()];
...
var isCampaignEvent = function (event) {
    if (event.event_type === '$identify' && event.user_properties) {
        ...
        var $set = properties[analytics_core_1.IdentifyOperation.SET] || {};
        var $unset = properties[analytics_core_1.IdentifyOperation.UNSET] || {};
        ...
        return Object.keys(analytics_core_1.BASE_CAMPAIGN).every(function (value) { return userProperties_1.includes(value); });
    }
    return false;
};
